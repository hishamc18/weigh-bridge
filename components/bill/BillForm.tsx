...
export default function BillForm({ shops, onBillCreated }: Props) {
    ...
    const [exportBillData, setExportBillData] = useState<IBill | null>(null);
    ...
    return (
        <>
            <div className="flex flex-col xl:flex-row gap-6 w-full min-w-0">
                ...
                <div className="w-full xl:flex-1 min-w-0 border border-black">
                    ...
                    <div className="px-4 sm:px-5 py-5 space-y-4">
                        <div>
                            <label className="block text-[11px] lg:text-xs font-bold tracking-widest uppercase mb-1">
                                Shop
                            </label>
                            <ShopDropdown
                                value={form.shopId}
                        ...
                        <div>
                            ...
                            <DateTimeInput value={form.printDate} onChange={(v) => set("printDate", v)} />
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <DateTimeInput value={form.grossTime} onChange={(v) => set("grossTime", v)} />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <DateTimeInput value={form.tareTime} onChange={(v) => set("tareTime", v)} />
                            </div>
                        </div>
                        ...
                        <div className="pt-2">
                            <button
                                ...
                                disabled={submitting}
                                className="w-full cursor-pointer bg-black text-white text-[11px] lg:text-xs font-bold tracking-widest uppercase py-3 hover:bg-neutral-800 transition-colors disabled:opacity-40"
                            >
            ...
            {/* ── Shared Export Modal ── */}
            <ExportModal bill={exportBillData} shop={selectedShop} onClose={() => setExportBillData(null)} />
        </>
    );
}
